													...
													<td>
														<div class="dropdown">
															...
															<div class="dropdown-menu tx-13">
																...
																href="{{ url("paymentStatus/$invoice->id") }}"><i
																...
																@endcan
																@can('طباعةالفاتورة')
																<a class="dropdown-item" href="printInvoice/{{ $invoice->id }}"><i class="text-success fas fa-print"></i>&nbsp;&nbsp;طباعة الفاتورة</a>
																@endcan
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<input type="hidden" name="invoice_id" id="invoice_id" value="">
							<input type="hidden" name="archive_id" id="id_page" value="1">
