								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											{{\App\Models\Invoice::sum("total")}}L.E
											</h4>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												{{\App\Models\Invoice::where("value_status" , "2")->sum("total")}}L.E
											</h4>
											<p class="mb-0 tx-12 text-white op-7">
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												{{\App\Models\Invoice::where("value_status" , "1")->sum("total")}}L.E
											</h4>
											<p class="mb-0 tx-12 text-white op-7">
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												{{\App\Models\Invoice::where("value_status" , "3")->sum("total")}}L.E
											</h4>
											<p class="mb-0 tx-12 text-white op-7">
