<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='home') }}">Invoice System </a>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='paidInvoices') }}">الفواتير المدفوعه</a></li>
							@endcan

							@can('الفواتير الغير مدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='UnpaidInvoices') }}">الفواتير الغير مدفوعه </a></li>
							@endcan

							@can('الفواتير المدفوعة جزئيا')
							<li><a class="slide-item" href="{{ url('/' . $page='PartialPaidInvoices') }}">الفواتير المدفوعه جزئيا</a></li>
							@endcan

							@can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='archiveInvoices') }}">  ارشيف الفواتير</a></li>
							@endcan
